...
def personaje(estado, pos_inicial_x, pos_inicial_y):
    if estado == 0:
        ...
        esc.draw_paredes("PersonajeEmma/imagesEV/fondo1.jpg")
        esc.draw_techo()
    ...
    if estado == 11: # SORPRESA
        ...
        esc.draw_paredes("PersonajeEmma/imagesEV/estadio.jpg")
        esc.draw_techo()
    ...
    if estado == 1: #Enojado
        ...
        esc.draw_paredes("PersonajeEmma/imagesEV/callejon.jpg")
        esc.draw_techo()
    ...
    if estado == 2: #TRISTE
        ...
        esc.draw_paredes("PersonajeEmma/imagesEV/Ciudad Oscura.jpeg")
        esc.draw_techo()
    ...
    if estado == 3: #SOSPECHOSO
        ...
        esc.draw_paredes("PersonajeEmma/imagesEV/crimen.jpg")
        esc.draw_techo()
    ...
    if estado == 4: #INDIFERENTE
        ...
        esc.draw_paredes("PersonajeEmma/imagesEV/indiferencia.jpg")
        esc.draw_techo()
    ...
    if estado == 5: #LEVANTANDO CEJA
        ...
        esc.draw_paredes("PersonajeEmma/imagesEV/pregunta.jpg")
        esc.draw_techo()
    ...
    if estado == 12: # SONRIENTE
        ...
        esc.draw_paredes("PersonajeEmma/imagesEV/playa.jpg")
        esc.draw_techo()
